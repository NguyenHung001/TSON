    ...
    <div class="main-products">
        ...
        <div class="container">
            <div class="content">
                <div class="left">
                    <div class="img">
                        <img src="<?php echo "./assets/imgs/" . $data[0]['image']; ?>" alt="">
                    </div>
                </div>
                <div class="right">
                    <div class="box">
                        <h4><?php echo $data[0]['pd_name']; ?></h4>
                        <div class="price"><?php echo $data[0]['pd_price']; ?></div>
                        <p><?php echo $data[0]['pd_detail']; ?></p>
                    </div>
                    <div class="addCart">
                        <a href="./handle-cart.php?id=<?php echo $data[0]['id']; ?>">Thêm vào giỏ hàng</a>
                    </div>
                </div>
            </div>
        </div>
